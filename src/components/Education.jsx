            ...
            {educationData.map((edu, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <p className={`text-sm font-medium ${
                      activeIndex === index ? 'text-blue-100' : 'text-blue-600 dark:text-blue-400'
                    }`}>
                      {edu.field}
                    </p>
                  </div>
                ...
                <div className={`space-y-2 text-sm ${
                  activeIndex === index ? 'text-blue-50' : 'text-gray-600 dark:text-gray-300'
                }`}>
                ...
                <p className={`mt-4 text-sm ${
                  activeIndex === index ? 'text-white' : 'text-gray-700 dark:text-gray-400'
                }`}>
                  {edu.description}
                </p>
              </div>
